...
def test_create_coverage_context_returns_expected_keys(sample_stations_df_2):
    result = create_coverage_context(
        stations_df=sample_stations_df_2,
...
def test_create_coverage_context_counts_stations_inside_catchment(sample_stations_df_2):
    result = create_coverage_context(
        stations_df=sample_stations_df_2,
        proposed_lat=51.5074,
        proposed_lon=-0.1278,
...
def test_create_coverage_context_finds_nearest_station(sample_stations_df_2):
    result = create_coverage_context(
        stations_df=sample_stations_df_2,
        proposed_lat=51.5074,
        proposed_lon=-0.1278,
...
def test_create_coverage_context_returns_affected_lines(sample_stations_df_2):
    result = create_coverage_context(
        stations_df=sample_stations_df_2,
        proposed_lat=51.5074,
        proposed_lon=-0.1278,
